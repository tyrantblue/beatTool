...
- 优化：节拍指示灯闪烁后 80ms 自动熄灭，不再常亮到下一拍
- 新增：设置弹窗 Done 按钮

### v0.3.0 (2026-05-14)
- 新增：设置面板 — 齿轮按钮打开弹窗，可切换主题色（5 色）、拍子音色（4 种）、指示灯动效（4 种）、边框特效（4 种）
- 新增：作者署名 "by Tyrant Blue"
- 新增：设置项 localStorage 持久化（@vueuse/core useStorage）
- 重构：useSettings composable 集中管理所有偏好设置

### v0.2.3 (2026-05-14)
- 修复：切换 BPM/拍号后重音位置错误，改为统一从第 1 拍（重音）重新开始
- 优化：重音节拍指示灯特效增强 — 更大尺寸、更强阴影、常驻提示环
